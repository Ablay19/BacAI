...
interface ModelRequest {
  ...
  request_type: 'solve' | 'explain' | 'converse'
}
...
export async function callModelService(payload: ModelRequest): Promise<ModelResponse> {
...
export function getFallbackResponse(requestType: string, language: string = 'en'): ModelResponse {
