...
export function extractSubject(text, language) {
...
export function validateCurriculumAlignment(subject, level, language) {
    ...
    const levelConfig = validCombinations[level];
    if (!levelConfig) {
        return false;
    }
